...
*/
    ...
    public static void logEventWithAds(Context context, Bundle params) {
        FirebaseAnalytics.getInstance(context).logEvent("nlbn_admob_paid_ad_impression", params);
    }

    static void logPaidAdImpressionValue(Context context, Bundle bundle) {
            FirebaseAnalytics.getInstance(context).logEvent("nlbn_admob_paid_ad_impression_value", bundle);
    }
    ...
    public static void logTotalRevenue001Ad(Context context, Bundle bundle) {
        FirebaseAnalytics.getInstance(context).logEvent("nlbn_admob_Daily_Ads_Revenue", bundle);
    }
